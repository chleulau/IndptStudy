...
def z3solving(array):
	...
	#Get all the variables and clean up the logic text once more
		...
		while (textstart < textend):
			if vargettext[textstart].isalpha():
				...
				if p:
					...
					if vargettext[textstart] == '=':
						if (vargettext[textstart - 1] == ' ') and (vargettext[textstart + 1] == ' '):
							newt = newt + '='
	...
	#Print the true basic paths in z3-friendly form
	print ' '
	print 'Basic paths in Z3-friendly form'
	for newarrayte in newarray:
		print newarrayte
	
	#Get the expressions to declare them as bools
